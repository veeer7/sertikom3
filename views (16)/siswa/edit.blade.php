{{-- Modern edit form with improved styling --}}
<x-app-layout>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-slate-900 dark:text-slate-100">Edit Siswa</h1>
            ...
            <form action="{{ route('siswa.update', $siswa->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="alamat" placeholder="Masukkan alamat lengkap" 
                              ...
                              style="resize: none;">{{ old('alamat', $siswa->alamat) }}</textarea>
