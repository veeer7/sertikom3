<x-app-layout>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100">Tambah Siswa</h1>
                <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">Isi form untuk menambah siswa baru</p>
            </div>
            ...
            <form action="{{ route('siswa.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="alamat" 
                              ...
                              class="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
